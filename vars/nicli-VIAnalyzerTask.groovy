...
//reportsavetype - Format of the report or results file.  The value for this argument must be one of the following: "ASCII", "HTML", "RSL File" 
...
//lv_portnumber - Specifies the port of the VI server (Tools»Options»VI Server»TCP/IP). If this argument is left blank (""), this command will default to 3363.
        ...
        bat "LabVIEWCLI -LabVIEWPath \"${lv_exe_filepath}\" -PortNumber \"${lv_portnumber}\" -OperationName RunVIAnalyzer -ConfigFilePath \"${via_configpath}\" -ReportPath \"${via_reportpath}\" -ReportSaveType \"${reportsavetype}\""
}
